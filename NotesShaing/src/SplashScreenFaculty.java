...
public class SplashScreenFaculty extends javax.swing.JFrame {

    public SplashScreenFaculty() {
        try {
            initComponents();
            
            BufferedImage orgimage = ImageIO.read(new File("E:\\Cloud Note Sharing Complete Project\\NotesShaing\\src\\sky teacher.png"));
            ...
            Logger.getLogger(SplashScreenFaculty.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public class progress implements Runnable
    {
        ...
        public void run() 
        {
          ...
          SplashScreenFaculty.this.dispose();
          new FacultyConnect();
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SplashScreenFaculty().setVisible(true);
            }
        });
    }
