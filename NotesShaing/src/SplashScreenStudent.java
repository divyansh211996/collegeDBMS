...
public class SplashScreenStudent extends javax.swing.JFrame {

    public SplashScreenStudent() {
        try {
            initComponents();
            
            BufferedImage orgimage = ImageIO.read(new File("E:\\Cloud Note Sharing Complete Project\\NotesShaing\\src\\sky student.png"));
            ...
            Logger.getLogger(SplashScreenStudent.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
  ...
  SplashScreenStudent.this.dispose();
          new StudentConnect();        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SplashScreenStudent().setVisible(true);
            }
        });
    }
